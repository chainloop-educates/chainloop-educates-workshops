...
A Next.js web application used as the sample project for the **Getting Started with Chainloop** workshop (Lab A01). This repository is pre-populated in the workshop's GitHub environment — learners add Chainloop attestation to its GitHub Actions workflow as part of the exercises.

The workflow in this repo is the **A01 starting state**: it builds and pushes a container image with no Chainloop integration yet. Learners add that during the workshop.
